...
cd "/Users/williamviolette/disc/"


* /Volumes/GoogleDrive/My Drive/disc_data
...
** (1) import disconnection policy tables
	...
	do "disc_code/subcode/import_dc_tables_2004_2009.do"
	do "disc_code/subcode/import_dc_tables_2011_2016.do"
	do "disc_code/subcode/combine_dc_tables.do"

	* clean data to look at cold temperature mortality 
	do "disc_code/subcode/cold_prep.do"
...
** (2) import temperature 
	...
	* this file won't run on your PC because the data isn't there
	do "disc_code/subcode/import_temperature.do"


** (3) quick test analysis

	do "disc_code/subcode/analysis_test_prep.do"
	...
	do "disc_code/subcode/analysis_test.do"
